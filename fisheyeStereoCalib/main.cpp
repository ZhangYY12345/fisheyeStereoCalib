...
int main()
{
	...
	*/
	...
	std::string resXml = "D:/studying/stereo vision/research code/fisheye-stereo-calibrate/fisheyeStereoCalib/fisheyeStereoCalib/fisheyeStereoCalib/patternsImgL/20191211.xml";
	double singleRms = fisheyeCamCalibSingle(xmlpath_img, resXml);
